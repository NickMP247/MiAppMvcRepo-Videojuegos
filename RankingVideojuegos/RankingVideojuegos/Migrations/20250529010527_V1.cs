...
namespace RankingVideojuegos.Migrations
{
    /// <inheritdoc />
    public partial class V1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlataformaVideojuego", x => new { x.VideojuegoId, x.PlataformaId });
                    table.ForeignKey(
                        name: "FK_PlataformaVideojuego_Plataformas_PlataformaId",
                        column: x => x.PlataformaId,
                        principalTable: "Plataformas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlataformaVideojuego_Videojuegos_VideojuegoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Valoraciones_Videojuegos_VideojuegoId",
                        column: x => x.VideojuegoId,
                        principalTable: "Videojuegos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlataformaVideojuego_PlataformaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Valoraciones_VideojuegoId",
                table: "Valoraciones",
                column: "VideojuegoId");
        }
